package com.tony_fire.chainreaction
...
import com.tony_fire.chainreaction.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.regButton.setOnClickListener {
            ...
            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f6ba30f157a24e1e302f5ee",ed2stName,ed_tel,"dfbdfavsdfds")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                binding.regButton.setBackgroundResource(R.drawable.background_rgselector_button_color)
                                val i = Intent(
                            ...
                            response.body()?.data?.pr.equals("exist") -> {
                                Toast.makeText(this@RegistrationActivity," Вы зарегистрированы!",
